    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            do {
                ...
                do {
                    rowMove = SafeInputs.getRangedInt(in, "Enter the row for your move.", 1, 3);
                    colMove = SafeInputs.getRangedInt(in, "Enter the column for your move.", 1, 3);
            ...
            if (isWin(currentPlayer)) {
                System.out.println("Congrats, player " + currentPlayer + " won!");
            } else {
                System.out.println("It's a tie.");
            }
            continueGame = SafeInputs.getYNConfirm(in, "Would you like to play again?");
        } while (continueGame);
    }
